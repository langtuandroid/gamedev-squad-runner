...
public class SquadDetection : MonoBehaviour
{
    ...
    {
        Collider[] detectedDoors = Physics.OverlapSphere(transform.position, squadFormation.GetSquadRadiussr(), doorLayer);
        ...
        squadFormation.AddRunnerssr(runnersAmountToAdd);
